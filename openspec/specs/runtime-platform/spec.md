# Especificação: runtime-platform

## Purpose
Define a plataforma de runtime JVM da aplicação: toolchain Kotlin compilando para JDK 25, imagem de runtime baseada em JRE 25 (`linux/amd64`), e build Docker multi-stage que produz e empacota um fat jar.
