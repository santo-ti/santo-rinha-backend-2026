...
## Purpose
Define o endpoint de readiness `GET /ready` da API: retorna status HTTP 2xx com corpo vazio quando o processo está pronto para receber tráfego, e é coberto por teste automatizado.
