# Especificação: container-deployment

## Purpose
Define a topologia de deployment via Docker Compose para a Rinha de Backend 2026: um load balancer Nginx e duas instâncias da API, expostas na porta pública 9999, dentro do envelope de recursos de ≤ 1 CPU e ≤ 350 MB, compatível com `linux/amd64`.
